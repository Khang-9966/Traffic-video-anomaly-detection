...
parser.add_argument('--wandb_log', type=str2bool, nargs='?', const=True, default=False, help='Wandb ML ops monitor')
...
parser.add_argument('--weight_init', type=str2bool, nargs='?', const=True, default=True, help='normal distribution weight init') 
parser.add_argument('--finalscore_maxnorm_byclip', type=str2bool, nargs='?', const=True, default=True, help='normal distribution weight init') 
######################################## MODEL CONFIG ##################################################
parser.add_argument('--use_flow_local_mem', type=str2bool, nargs='?', const=True, default=True, help='use local mem or global mem for image decoder')
parser.add_argument('--use_im_local_mem', type=str2bool, nargs='?', const=True, default=True, help='use local mem or global mem for flow decoder')
parser.add_argument('--use_im_memory', type=str2bool, nargs='?', const=True, default=True, help='use mem for image decoder')
parser.add_argument('--use_flow_memory', type=str2bool, nargs='?', const=True, default=True, help='use mem for flow decoder')
parser.add_argument('--use_im_skipcon_1', type=str2bool, nargs='?', const=True, default=False, help='use skip con 1 for image decoder') 
parser.add_argument('--use_im_skipcon_2', type=str2bool, nargs='?', const=True, default=False, help='use skip con 2 for image decoder') 
parser.add_argument('--use_im_skipcon_3', type=str2bool, nargs='?', const=True, default=False, help='use skip con 3 for image decoder') 
parser.add_argument('--use_im_skipcon_4', type=str2bool, nargs='?', const=True, default=False, help='use skip con 4 for image decoder') 
parser.add_argument('--use_flow_skipcon_1', type=str2bool, nargs='?', const=True, default=True, help='use skip con 1 for flow decoder') 
parser.add_argument('--use_flow_skipcon_2', type=str2bool, nargs='?', const=True, default=True, help='use skip con 2 for flow decoder') 
parser.add_argument('--use_flow_skipcon_3', type=str2bool, nargs='?', const=True, default=True, help='use skip con 3 for flow decoder') 
parser.add_argument('--use_flow_skipcon_4', type=str2bool, nargs='?', const=True, default=True, help='use skip con 4 for flow decoder') 
